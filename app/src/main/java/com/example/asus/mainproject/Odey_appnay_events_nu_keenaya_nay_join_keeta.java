...
public class Odey_appnay_events_nu_keenaya_nay_join_keeta extends AppCompatActivity {
   ...
   Adpater adapter ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_odey_appnay_events_nu_keenaya_nay_join_keeta);
        list = new ArrayList<>();
        ...
        public void onBindViewHolder(view_holder holder, int position) {
            ...
            holder.event_cell.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent i = new Intent(Odey_appnay_events_nu_keenaya_nay_join_keeta.this , MyEventSingleActivity.class);
